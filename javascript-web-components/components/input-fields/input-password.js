const templateInputPassword = document.createElement('template');
templateInputPassword.innerHTML = `
<style>
    input{
...
export class InputPassword extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.appendChild(templateInputPassword.content.cloneNode(true));
    }
