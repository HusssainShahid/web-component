const templateRaisedButton = document.createElement('template');
templateRaisedButton.innerHTML = `
<style>
    .button{
        position: relative;
        border: none;
...
export class RaisedButton extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot.appendChild(templateRaisedButton.content.cloneNode(true));
    }
...
window.customElements.define('raised-button', RaisedButton);