const languageSetTemplate = document.createElement('template');
languageSetTemplate.innerHTML = `
<style>
...
<div class="wrapper">
    <div class="title p-bottom">Langauges</div>
    <div id="languages-set"></div>
</div>
`;

export class LanguagesSet extends HTMLElement {

    constructor() {
        super();
        this.attachShadow({mode: 'open'});
        this.shadowRoot.appendChild(languageSetTemplate.content.cloneNode(true));
    }
    ...
    generateView() {
        ...
        for (let i = 0; i < this.data.length; i++) {
            ...
            `;
            this.shadowRoot.querySelector('#languages-set').appendChild(container)
        }
    }
...
window.customElements.define('languages-set', LanguagesSet);
